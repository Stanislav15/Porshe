...
import utilities.TestBase3;

import java.util.ArrayList;
import java.util.List;
import java.util.Set;

public class AddEditOrder extends TestBase3 {
    ...
    public void testProducts(){
        ...
        productNamesViewAll = new ArrayList<>();
...
//        System.out.println("All products are found");
    ...
    public void edit() throws InterruptedException{
        ...
        String quantityPrevious = driver.findElement(By.id("ctl00_MainContent_fmwOrder_txtQuantity")).getAttribute("value");
